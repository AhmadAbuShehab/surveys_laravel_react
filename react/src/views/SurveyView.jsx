...
export default function SurveyView() {
    ...
    function onsubmit(event) {
        ...
        console.log("Form submitted", survey);
    }
            ...
            <form action="#" method="POST" onSubmit={onsubmit}>
                <div className="shadow sm:overflow-hidden sm:rounded-md">
                    <div className="space-y-6 bg-white px-4 py-5 sm:p-6">
                        <div>
                            ...
                            <div className="mt-1 flex items-center">
                                ...
                                {!survey.image_url && (
                                    ...
                                    <button type="button" className="relative ml-5 rounded-md border border-gray-300 bg-white py-2 px-3 test-sm
                                    font-meduim leading-4 text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none
                                    focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                                        <input
                                            type="file"
                                            className="absolute inset-0 h-full w-full cursor-pointer
                                            rounded-md border-gray-300 opacity-0"
                        ...
                        <div>
                            <TButton type="submit" color="green">
                                Save
                            </TButton>
                        </div>
